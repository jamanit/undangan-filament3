...
return [
    ...
    'custom_fields' => [
        'whatsapp_number' => [
            'type' => 'text', // tipe input adalah text
            'label' => 'WhatsApp Number', // label untuk form
            'id' => 'whatsapp-number', // id untuk input field
            'required' => false, // field wajib diisi
            'rules' => ['required', 'regex:/^(\+62|62|0)8[1-9][0-9]{6,9}$/'], // aturan validasi
            'column_span' => 'full', // column span full
        ],
