...
use App\Filament\Resources\InvitationWeddingFloralResource\Pages;
use App\Filament\Resources\InvitationWeddingFloralResource\RelationManagers;
...
use App\Filament\Resources\InvitationWeddingFloralResource\forms;
use App\Models\User;
use App\Models\Template;

class InvitationWeddingFloralResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListInvitationWeddingFlorals::route('/'),
            'edit' => Pages\EditInvitationWeddingFloral::route('/{record}/edit'),
        ];
    }
}
