...
class InvitationsChart extends ChartWidget
{
    ...
    protected function getData(): array
    {
        ...
        $visitors = Invitation::select(DB::raw('strftime("%Y-%m", created_at) as month_year'), DB::raw('COUNT(*) as total'))
    ...
    {
        $maxInvitations = max($this->getData()['datasets'][0]['data']); // Mendapatkan jumlah pengunjung maksimum
