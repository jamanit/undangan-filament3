        ...
        <div id="content" class="z-10 relative h-screen overflow-y-hidden lg:w-1/3">
            ...
            <section id="cover-section" class="z-10 relative h-screen w-full overflow-hidden">
                <div class="absolute h-full w-full flex justify-start items-center">
                    <img loading="lazy" src="{{ asset('/') }}assets/floral-template/images/golden-brown/41.png" class="z-10 absolute w-full inset-x-0 top-0" data-aos="fade-down" />
                    <img loading="lazy" src="{{ asset('/') }}assets/floral-template/images/golden-brown/42.png" class="z-20 absolute w-full inset-x-0 top-0" data-aos="fade-right" />

                    <img loading="lazy" src="{{ asset('/') }}assets/floral-template/images/golden-brown/43.png" class="z-10 absolute w-full inset-x-0 bottom-0" data-aos="fade-up" />
                    <img loading="lazy" src="{{ asset('/') }}assets/floral-template/images/golden-brown/44.png" class="z-20 absolute w-full inset-x-0 bottom-0" data-aos="fade-left" />
                </div>
                ...
                <div class="z-30 relative h-full w-full flex items-center justify-center flex-col">
                    ...
                    <div class="flex flex-col items-center justify-center mb-4">
                        <div class="z-40 absolute flex flex-col text-center" data-aos="zoom-in">
                            <p class="font-sacramento text-4xl font-semibold text-primary-golden-brown-400">{{ $invitation->weddingCouple->bride_nickname ?? 'Wanita' }}</p>
                            <p class="font-sacramento text-4xl font-semibold text-primary-golden-brown-400">&</p>
                            <p class="font-sacramento text-4xl font-semibold text-primary-golden-brown-400">{{ $invitation->weddingCouple->groom_nickname ?? 'Pria' }}</p>
                        </div>
                        <img loading="lazy" src="{{ asset('/') }}assets/floral-template/images/golden-brown/11.png" class="z-30 w-full h-full" data-aos="zoom-in" />
                    </div>
            ...
            <section id="quote-section" class="z-10 relative min-h-screen w-full overflow-hidden">
                <div class="absolute h-full w-full flex justify-start items-center">
                    ...
                    <img loading="lazy" src="{{ asset('/') }}assets/floral-template/images/golden-brown/42.png" class="z-20 absolute w-full inset-x-0 bottom-0" data-aos="fade-right" />
                    <img loading="lazy" src="{{ asset('/') }}assets/floral-template/images/golden-brown/43.png" class="z-10 absolute w-full inset-x-0 bottom-0" data-aos="fade-up" />
                    <img loading="lazy" src="{{ asset('/') }}assets/floral-template/images/golden-brown/44.png" class="z-20 absolute w-full inset-x-0 bottom-0" data-aos="fade-left" />
                </div>
                ...
                <div class="z-30 px-4 py-8 relative min-h-screen w-full flex flex-col items-center justify-center">
                        ...
                        @else
                            <div class="px-2">
                                ...
                                <div class="mb-4 flex items-center space-x-4 justify-start" data-aos="fade-right">
                                    <img loading="lazy" src="{{ Storage::url($invitation->weddingCouple->bride_photo) }}" class="mb-2 h-36 w-28 rounded-b-[30%] rounded-t-[30%] border-4 border-primary-golden-brown-400 object-cover" />
                                    <div class="text-left">
                                        <p class="font-sacramento text-4xl font-semibold text-primary-golden-brown-400">{{ $invitation->weddingCouple->bride_nickname }}</p>
                                ...
                                <div data-aos="fade-left">
                                    ...
                                    <div class="mb-4 flex items-center space-x-4 justify-end">
                                        <div class="text-right">
                                            <p class="font-sacramento text-4xl font-semibold text-primary-golden-brown-400">{{ $invitation->weddingCouple->groom_nickname }}</p>
                                        ...
                                        <img loading="lazy" src="{{ Storage::url($invitation->weddingCouple->groom_photo) }}" class="mb-2 h-36 w-28 rounded-b-[30%] rounded-t-[30%] border-4 border-primary-golden-brown-400 object-cover" />
                                    </div>
                                </div>
                            </div>
                        @endif
                    @else
                        <div class="px-2">
                            ...
                            <div class="mb-4 flex items-center space-x-4 justify-start" data-aos="fade-right">
                                <img loading="lazy" src="{{ asset('/') }}assets/images/wedding-couples/girl.jpg" class="mb-2 h-36 w-28 rounded-b-[30%] rounded-t-[30%] border-4 border-primary-golden-brown-400 object-cover" />
                                <div class="text-left">
                            ...
                            <div data-aos="fade-left">
                                ...
                                <div class="mb-4 flex items-center space-x-4 justify-end">
                                    ...
                                    <img loading="lazy" src="{{ asset('/') }}assets/images/wedding-couples/boy.jpg" class="mb-2 h-36 w-28 rounded-b-[30%] rounded-t-[30%] border-4 border-primary-golden-brown-400 object-cover" />
                                </div>
                            </div>
                        </div>
                    @endif
            ...
            <section id="event-section" class="z-10 relative min-h-screen w-full overflow-hidden">
                ...
                <div class="z-30 relative px-4 py-8 min-h-screen w-full flex flex-col items-center justify-center">
                        ...
                        @else
                            ...
                            @foreach ($invitation->events->sortBy('event_date') as $event)
                                <div class="mb-4 w-full rounded-lg border-2 border-primary-golden-brown-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-right">
                                    <p class="mb-2 font-sacramento text-4xl font-semibold text-primary-golden-brown-400">{{ $event->type }}</p>
                                    ...
                                    @if ($event->map_url)
                                        <a href="{{ $event->map_url }}" target="_blank">
                                            <button class="cursor-pointer mx-auto mt-1 rounded-full bg-primary-golden-brown-500 px-4 py-2 text-sm text-white hover:bg-primary-golden-brown-600">
                    ...
                    @else
                        ...
                        <div class="mb-4 w-full rounded-lg border-2 border-primary-golden-brown-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-right">
                            <p class="mb-2 font-sacramento text-4xl font-semibold text-primary-golden-brown-400">Akad Nikah</p>
                        ...
                        <div class="mb-4 w-full rounded-lg border-2 border-primary-golden-brown-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-left">
                            <p class="mb-2 font-sacramento text-4xl font-semibold text-primary-golden-brown-400">Resepsi</p>
                            <p class="text-lg font-semibold">Minggu, 23 Oktober 2025</p>
                        ...
                        <div class="mb-4 w-full rounded-lg border-2 border-primary-golden-brown-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-right">
                            <p class="mb-2 font-sacramento text-4xl font-semibold text-primary-golden-brown-400">Ngunduh Mantu
                            </p>
                            <p class="text-lg font-semibold">Minggu, 23 Oktober 2025</p>
                            <p class="text-lg font-semibold">08:00 WIB</p>
                    ...
                    <div class="mb-4 w-full rounded-lg border-2 border-primary-golden-brown-400 bg-white/75 p-4 shadow-lg" data-aos="zoom-in">
                        <form id="message-form" method="POST">
                            ...
                            <div class="mb-4" id="guest_input" style="display: none">
                                ...
                                <input type="number" name="guest_total" id="guest_total" placeholder="Masukkan jumlah tamu (orang)" class="w-full rounded-lg border border-primary-golden-brown-400 p-3 focus:outline-none focus:ring-2 focus:ring-primary-golden-brown-400" />
                            </div>
                            <button type="button" id="send-message-btn" class="cursor-pointer mt-4 w-full rounded-full bg-primary-golden-brown-500 p-2 text-base text-white hover:bg-primary-golden-brown-600">
                                <i class="fas fa-message"></i> SEND MESSAGE
                            </button>
                        </form>

                        @if ($invitation)
                            <div id="messages" data-color="text-primary-golden-brown-400" class="mt-8 max-h-96 overflow-y-auto space-y-4 rounded-lg border border-gray-300 p-2">
                            </div>
                        @else
                            <div class="mt-8 max-h-96 overflow-y-auto space-y-4 rounded-lg border border-gray-300 p-2">
                                ...
                                <div class="bg-green-100 p-4 rounded-md shadow-md">
                                    <p class="font-semibold text-primary-golden-brown-500 text-sm">Nama Pengirim 1</p>
                                ...
                                <div class="bg-green-100 p-4 rounded-md shadow-md">
                                    <p class="font-semibold text-primary-golden-brown-500 text-sm">Nama Pengirim 2</p>
                                    <p class="text-gray-700 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit.
                                        Nullam scelerisque urna nec nisi auctor, a tincidunt libero iaculis.</p>
                                </div>
                                <div class="bg-green-100 p-4 rounded-md shadow-md">
                                    <p class="font-semibold text-primary-golden-brown-500 text-sm">Nama Pengirim 3</p>
                                    <p class="text-gray-700 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit.
                                        Nullam scelerisque urna nec nisi auctor, a tincidunt libero iaculis.</p>
                                </div>
                                <div class="bg-green-100 p-4 rounded-md shadow-md">
                                    <p class="font-semibold text-primary-golden-brown-500 text-sm">Nama Pengirim 4</p>
                                    <p class="text-gray-700 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit.
                                        Nullam scelerisque urna nec nisi auctor, a tincidunt libero iaculis.</p>
                                </div>
                                <div class="bg-green-100 p-4 rounded-md shadow-md">
                                    <p class="font-semibold text-primary-golden-brown-500 text-sm">Nama Pengirim 5</p>
                                    <p class="text-gray-700 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit.
                                        Nullam scelerisque urna nec nisi auctor, a tincidunt libero iaculis.</p>
                                </div>
                    ...
                    <div class="max-h-[70vh] overflow-y-auto px-4 pb-8 pt-4">
                                ...
                                @foreach ($invitation->gifts->sortBy('order') as $gift)
                                    @if ($gift->type == 'Rekening')
                                        <div class="relative mb-4">
                                            <img loading="lazy" src="{{ asset('/') }}assets/floral-template/images/card-money.jpg" class="h-40 w-full rounded-3xl border-2 border-primary-golden-brown-400 object-cover" />
                                            <div class="absolute inset-0 flex flex-col items-start justify-center pl-4">
                                                <p class="px-4 py-1 text-2xl font-semibold text-primary-golden-brown-400">{{ $gift->account_name }}</p>
                                                <p class="px-4 py-1 text-2xl">
                                                    {{ $gift->account_number }}
                                                    <i id="copy-icosn" class="fa-regular fa-copy cursor-pointer hover:text-primary-golden-brown-400" onclick="copyToClipboard('bg-primary-golden-brown-500', '{{ $gift->account_number }}')"></i>
                                                </p>
                                            ...
                                            <div class="flex rounded-3xl border-2 border-primary-golden-brown-400 p-2">
                                                ...
                                                <div class="flex flex-col justify-center">
                                                    ...
                                                    <p class="px-1 py-1 text-base">
                                                        ...
                                                        <i class="fa-regular fa-copy cursor-pointer text-2xl hover:text-primary-golden-brown-400" onclick='copyToClipboard("bg-primary-golden-brown-500", "Name: {{ $gift->recipient_name }}, Phone Number: {{ $gift->recipient_phone_number }}, Address: {{ $gift->recipient_address }}")'></i>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        @else
                            <div class="relative mb-4">
                                <img loading="lazy" src="{{ asset('/') }}assets/floral-template/images/card-money.jpg" class="h-40 w-full rounded-3xl border-2 border-primary-golden-brown-400 object-cover" />
                                <div class="absolute inset-0 flex flex-col items-start justify-center pl-4">
                                    <p class="px-4 py-1 text-2xl font-semibold text-primary-golden-brown-400">BSI</p>
                                    <p class="px-4 py-1 text-2xl">
                                        1234567890
                                        <i id="copy-icosn" class="fa-regular fa-copy cursor-pointer hover:text-primary-golden-brown-400" onclick="copyToClipboard('bg-primary-golden-brown-500', '1234567890')"></i>
                                    </p>
                                ...
                                <div class="flex rounded-3xl border-2 border-primary-golden-brown-400 p-2">
                                    ...
                                    <div class="flex flex-col justify-center">
                                        ...
                                        <p class="px-1 py-1 text-base">
                                            ...
                                            <i class="fa-regular fa-copy cursor-pointer text-2xl hover:text-primary-golden-brown-400" onclick='copyToClipboard("bg-primary-golden-brown-500", "Name: Nama Penerima, Phone Number: 081234567890, Address: Lorem ipsum dolor sit amet consectetur Voluptas quaerat nulla velit.")'></i>
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="z-30 relative px-4 py-8 flex flex-col items-center justify-center">
                    ...
                    <div class="px-2">
                        <div class="mb-4 text-center">
                            <img loading="lazy" src="{{ asset('/') }}assets/floral-template/images/golden-brown/45.png" class="z-20 w-full inset-x-0 mb-4" data-aos="fade-down" />
                            ...
                            <img loading="lazy" src="{{ asset('/') }}assets/floral-template/images/golden-brown/46.png" class="z-20 w-full inset-x-0 mb-4" data-aos="fade-up" />
                        </div>
                    </div>
                </div>
            </section>
