    ...
    <div class="container mx-auto px-4 py-6">
        <div class="flex flex-col items-center text-white">
            ...
            <div class="text-center">
                <p class="text-sm">
                    Copyright &copy; 2024 {{ $siteConfigs['site_name']->value ?? 'Site Name' }} by <a href="{{ env('COPYRIGHT_URL', 'Copyright URL') }}" target="_blank" class="font-semibold text-{{ $color }}-400">{{ env('COPYRIGHT_NAME', 'Copyright Name') }}</a>. All rights reserved.
                </p>
            </div>
        </div>
    </div>
