                            ...
                            <div class="flex rounded-3xl border-2 border-primary-golden-brown-400 p-2">
                                ...
                                <div class="flex flex-col justify-center">
                                    ...
                                    <p class="px-1 py-1 text-base">
                                        ...
                                        <i class="fa-regular fa-copy cursor-pointer text-2xl hover:text-primary-golden-brown-400" onclick='copyToClipboard("bg-primary-golden-brown-500", "Nama Penerima / 081234567890 / Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut, laboriosam perferendis! Voluptas quaerat nulla velit.")'></i>
                                    </p>
                                </div>
                            </div>
                        </div>
