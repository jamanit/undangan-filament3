                    ...
                    <div class="grid grid-cols-1">
                        <div class="text-center">
                            @if ($siteConfigs['white_logo']->file)
                                <img src="{{ Storage::url($siteConfigs['white_logo']->file) }}" class="block mx-auto h-16" alt="">
                            @else
                                <img src="{{ asset('/') }}assets/hoxia-v1/images/logo-icon-64.png" class="block mx-auto h-16" alt="">
                            @endif
